...
while (1):
    ...
    try:  # um erro ocorre se não encontrar nada na janela, pois não
        ...
        cv2.rectangle(frame, (100, 100), (300, 300),
                      (0, 255, 0), 0)  # leitura da máscara
        # conversão do padrão RGB para HSV
    ...
    # definindo a região de interesse
        ...
        if l == 1:
          ...
          # os.system("start Excel.exe --window-size=600,400")
            ...
            if arearatio < 27:
                cv2.putText(frame, '3 = Power Point', (0, 50),
                            font, 2, (0, 0, 255), 3, cv2.LINE_AA)
